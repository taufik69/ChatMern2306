          ...
          <div className=" divide-y-[1px] divide-gray-200">
            {user?.map((item) => (
              ...
              >
                ...
                <div>
                  <button className="rounded-md bg-gradient-to-r from-[#614385] to-[#1D2B64] px-3 py-2 font-bold text-white transition-all hover:bg-gradient-to-l hover:from-[#134E5E] hover:to-[#71B280]">
                    Accept
                  </button>
                </div>
              </div>
